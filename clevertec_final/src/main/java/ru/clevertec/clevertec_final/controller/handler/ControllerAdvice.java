package ru.clevertec.clevertec_final.controller.handler;
...
import ru.clevertec.clevertec_final.dto.errors.ErrorMessage;
import ru.clevertec.clevertec_final.dto.errors.StructuredError;
import ru.clevertec.clevertec_final.security.exceptions.MyRoleNotFoundException;
...
public class ControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handle(MyRoleNotFoundException e, HttpServletRequest req){
        return ResponseEntity.badRequest().body(ErrorMessage.builder()
                .message(e.getMessage())
                .status(BAD_REQUEST)
                .uri(req.getRequestURI())
    ...
    public ResponseEntity<ErrorMessage>handle(ReadTimeoutException e, HttpServletRequest req){
        return ResponseEntity.internalServerError().body(ErrorMessage.builder()
